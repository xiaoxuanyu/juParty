 ...
 *  删除图片及回调
 */
-(void)delete:(void(^)())ItemImageDeleteCompleteBlock failBlock:(void(^)())failBlock{
...
//    self.FailBlock = failBlock;
  [self.photoImageView.image deletePhotosAlbum:ItemImageDeleteCompleteBlock failBlock:failBlock];
}
/*
 *  保存图片及回调
 */
