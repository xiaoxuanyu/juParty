...
//    [self setImage:[UIImage imageNamed:@"PB.bundle/preview_save_icon_disable"] forState:UIControlStateDisabled];
    ...
    [self setImage:[UIImage imageNamed:@"icon_delete_grey"] forState:UIControlStateHighlighted];
    [self setImage:[UIImage imageNamed:@"icon_delete_grey"] forState:UIControlStateDisabled];
}
